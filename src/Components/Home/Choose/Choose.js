           ...
           <h1 className='text-4xl font-serif mt-10 text-center '> Choose a Way to Support Food First </h1>
             ...
             <div className='w-4/5 mx-auto  image py-28  '>
                  ...
                  <div className='flex justify-between gap-7 '>
                       ...
                       <div className='bg-[#ffffff] shadow-lg py-10 px-8 rounded-tl-[80px] hover:rounded-tl-none rounded-br-[80px] hover:rounded-br-none ease-linear duration-500  hover:rounded-tr-[80px] hover:rounded-bl-[80px] '>
                           <img className='w-15 h-12 mb-6' src="https://foodfirst.org/wp-content/uploads/2022/04/support_icons_1.png" alt="" />
                           <h1 className='text-sky-300 font-bold' >ONE-TIME GIFT</h1>
                       ...
                       <div className='bg-[#ffffff] shadow-md mt-8 pb-10 py-10 px-8    rounded-tl-[80px] hover:rounded-tl-none rounded-br-[80px] hover:rounded-br-none ease-linear duration-500  hover:rounded-tr-[80px] hover:rounded-bl-[80px] '>
                           <img className='w-15 h-12 mb-6'  src="https://foodfirst.org/wp-content/uploads/2022/04/support_icons_3.png" alt="" />
                           <h1 className='text-sky-300 font-bold'>MONTHLY DONATION</h1>
                       ...
                       <div className='bg-[#ffffff] shadow-md py-10 px-8  rounded-tl-[80px] hover:rounded-tl-none rounded-br-[80px] hover:rounded-br-none ease-linear duration-500  hover:rounded-tr-[80px] hover:rounded-bl-[80px] '>
                           <img className='w-15 h-12 mb-6'  src="https://foodfirst.org/wp-content/uploads/2022/04/support_icons_5.png" alt="" />
                           <h1 className='text-sky-300 font-bold'>LIVING LEGACY</h1>
                  ...
                  <div className='bg-[#ffffff] shadow-md w-1/3 py-10 px-8  rounded-tl-[80px] hover:rounded-tl-none rounded-br-[80px] hover:rounded-br-none ease-linear duration-500  hover:rounded-tr-[80px] hover:rounded-bl-[80px] '>
                           <img className='w-15 h-12 mb-6'  src="https://foodfirst.org/wp-content/uploads/2022/04/support_icons_4.png" alt="" />
                           <h1 className='text-sky-300 font-bold'> DONATING STOCK </h1>
                       ...
                       <div className='bg-[#ffffff] shadow-md  w-1/3 py-10 px-8    rounded-tl-[80px] hover:rounded-tl-none rounded-br-[80px] hover:rounded-br-none ease-linear duration-500  hover:rounded-tr-[80px] hover:rounded-bl-[80px] '>
                           ...
                           <h1 className='text-sky-300 font-bold'>FOR YOUR LOVED ONES</h1>
