    ...
    return (
        <div className='my-20 mx-5'>
            <div>
               ...
               <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 mt-16  gap-10'>
                    <div className=' pb-4 custom bg-[#F5F5F5] shadow-sm hover:bg-[#FFFFFF]'>
                        ...
                        <p className='text-center lg:text-start ml-2'>Senior Chef</p>
                    </div>
                    ...
                    <div className=' pb-4 custom   shadow-sm hover:bg-[#FFFFFF]'>
                        ...
                        <h1 className='text-center lg:text-start text-2xl font-semibold text-[#231900] mt-3 mb-3 ml-2'>Angelina John</h1>
                        <p className='text-center lg:text-start ml-2'>Master Chef</p>
                    </div>
                    ...
                    <div className=' pb-4 custom   shadow-sm hover:bg-[#FFFFFF]'>
                        ...
                        <h1 className='text-center lg:text-start text-2xl font-semibold ml-2 text-[#231900] mt-3 mb-3'>Christina Chi</h1>
                        <p className='text-center lg:text-start ml-2'>Psychologist</p>
                    </div>
